...
class StoryBrain {
  ...
  void nextStory(choiceNumber) {
    switch (_storyNum) {
      case 0:
        if (choiceNumber == 1) _storyNum = 2;
        if (choiceNumber == 2) _storyNum = 1;
        break;
      case 1:
        if (choiceNumber == 1) _storyNum = 2;
        if (choiceNumber == 2) _storyNum = 3;
        break;
      case 2:
        if (choiceNumber == 1) _storyNum = 5;
        if (choiceNumber == 2) _storyNum = 4;
        break;
      default:
        _storyNum = 0;
    }
